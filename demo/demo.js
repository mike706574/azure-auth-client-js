    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return client.getIdentityToken();
          ...
          case 2:
            ...
            if (response.ok) {
              ...
              if (response.reason === 'login-error') {
                _message = response.reason + '\n\n' + response.error + '\n\n' + response.message;

                document.getElementById("text").innerHTML = _message;
              } else {
...
var _azureAuthClient = __webpack_require__(87);

var _azureAuthClient2 = _interopRequireDefault(_azureAuthClient);
...
window.logOut = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
...
var _assign3 = __webpack_require__(89);
...
var _getOwnPropertyNames = __webpack_require__(118);

var _getOwnPropertyNames2 = _interopRequireDefault2(_getOwnPropertyNames);

var _getPrototypeOf3 = __webpack_require__(121);
...
var _create3 = __webpack_require__(126);
...
var _defineProperty3 = __webpack_require__(132);

var _defineProperty4 = _interopRequireDefault2(_defineProperty3);

var _typeof5 = __webpack_require__(135);
...
(function webpackUniversalModuleDefinition(root, factory) {
  if (( false ? 'undefined' : (0, _typeof6.default)(exports)) === 'object' && ( false ? 'undefined' : (0, _typeof6.default)(module)) === 'object') module.exports = factory();else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : (0, _typeof6.default)(exports)) === 'object') exports["azure-auth-client"] = factory();else root["azure-auth-client"] = factory();
})(undefined, function () {
  return (/******/function (modules) {
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */(function (global) {
        ...
        // kept identical to the way it is obtained in runtime.js
        var g = (typeof global === 'undefined' ? 'undefined' : (0, _typeof6.default)(global)) === "object" ? global : (typeof window === 'undefined' ? 'undefined' : (0, _typeof6.default)(window)) === "object" ? window : (typeof self === 'undefined' ? 'undefined' : (0, _typeof6.default)(self)) === "object" ? self : this;
      ...
      /* WEBPACK VAR INJECTION */(function (global) {
        ...
        */
        ...
        !function (global) {
          ...
          var hasOwn = Op.hasOwnProperty;
          var undefined; // More compressible than void 0.
          var $Symbol = typeof _symbol4.default === "function" ? _symbol4.default : {};
          var iteratorSymbol = $Symbol.iterator || "@@iterator";
          var asyncIteratorSymbol = $Symbol.asyncIterator || "@@asyncIterator";
          var toStringTagSymbol = $Symbol.toStringTag || "@@toStringTag";

          var inModule = (typeof module === 'undefined' ? 'undefined' : (0, _typeof6.default)(module)) === "object";
          var runtime = global.regeneratorRuntime;
          if (runtime) {
            if (inModule) {
              // If regeneratorRuntime is defined globally and we're in a module,
          ...
          var getProto = _getPrototypeOf4.default;
          var NativeIteratorPrototype = getProto && getProto(getProto(values([])));
          ...
          runtime.mark = function (genFun) {
            if (_setPrototypeOf4.default) {
              (0, _setPrototypeOf4.default)(genFun, GeneratorFunctionPrototype);
            } else {
              genFun.__proto__ = GeneratorFunctionPrototype;
              if (!(toStringTagSymbol in genFun)) {
                genFun[toStringTagSymbol] = "GeneratorFunction";
          ...
          function AsyncIterator(generator) {
            function invoke(method, arg, resolve, reject) {
              ...
              if (record.type === "throw") {
                ...
                var result = record.arg;
                var value = result.value;
                if (value && (typeof value === 'undefined' ? 'undefined' : (0, _typeof6.default)(value)) === "object" && hasOwn.call(value, "__await")) {
            ...
            if ((0, _typeof6.default)(global.process) === "object" && global.process.domain) {
              invoke = global.process.domain.bind(invoke);
            }
        ...
        // object, this seems to be the most reliable technique that does not
        // use indirect eval (which violates Content Security Policy).
        (typeof global === 'undefined' ? 'undefined' : (0, _typeof6.default)(global)) === "object" ? global : (typeof window === 'undefined' ? 'undefined' : (0, _typeof6.default)(window)) === "object" ? window : (typeof self === 'undefined' ? 'undefined' : (0, _typeof6.default)(self)) === "object" ? self : this);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(11)(Function.call, __webpack_require__(36).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
$export($export.S + $export.F * !__webpack_require__(7), 'Object', { defineProperties: __webpack_require__(45) });
